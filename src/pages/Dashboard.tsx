...
const Dashboard = () => {
  ...
  const handleViewContract = (contractName: string, uri: string) => {
    navigate(
      `/contract/${encodeURIComponent(contractName)}?uri=${encodeURIComponent(
        uri
      )}`
    );
  };
  ...
  const stats = [
    ...
    {
      title: "In Progress",
      value: Math.floor(folders.length * 0.2).toString(),
      color: "text-blue-600",
    },
    {
      title: "Completed",
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="space-y-4">
        <p className="text-muted-foreground">
          Select a contract to view their details
        </p>
                  ...
                  <TableRow key={folder.uri}>
                    ...
                    <TableCell>
                      <Button
                        ...
                        className="gap-2"
                        onClick={() =>
                          handleViewContract(folder.name, folder.uri)
                        }
                      >
